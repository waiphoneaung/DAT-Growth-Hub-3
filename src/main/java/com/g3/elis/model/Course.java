...
public class Course {
	...
	public Course(int id, String courseTitle, String courseDescription, String status, Timestamp createdAt, String duration,
			boolean courseCompletedStatus, double progress, String courseImageFileName, Timestamp updatedDate, User users,
			CourseCategory courseCategories, CourseTag courseTags, Set<EnrolledCourse> enrolledCourses) {
		super();
		this.id = id;
		this.courseTitle = courseTitle;
		this.courseDescription = courseDescription;
